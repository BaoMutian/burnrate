...
const dict = {
  ...
  zh: {
    nav: { download: '立即下载' },
    hero: {
      title: '告别订阅焦虑，让消费速率实时可见。',
      subtitle: '从 ChatGPT 到影音会员，数字化生活充满了隐形账单。BurnRate 驻留在 macOS 菜单栏，为您实时监控订阅支出，让每一分钱的流向都清晰明了。',
      cta: '免费下载 macOS 版',
      badge: '开源且免费 · 无需注册 · 数据本地化',
    },
    features: {
      heading: '掌控每一分数字现金流。',
      subheading: '最好的理财工具是一目了然。',
      menubar: {
        title: '无缝融入系统',
      ...
      instant: {
        title: '80+ 常用服务预设',
        desc: '内置 AI 工具、影音娱乐及开发环境预设。选择即添加，自动填入价格。也支持秒级创建自定义服务。',
      },
      realtime: {
        title: '实时消耗计数器',
      ...
      private: {
        title: '本地优先，绝对私密',
        desc: '财务数据不应上云。所有信息仅存储于本地 SQLite 数据库。无追踪、无账户、不联网，安全至极。',
      },
    },
    burn: {
      title: '看着钱在燃烧，真实且直观。',
      subtitle: '消耗计数器将您的月度订阅换算为每秒支出，通过实时跳动的数字，让抽象的账单变成具象的流逝感。',
      label: '今日已消耗',
      ofDaily: '日均预计 ¥338.50',
    },
    showcase: {
      title: '每一分钱花在哪，一清二楚。',
      subtitle: '多维度的分类统计、自动汇率换算、精准的账单周期提醒。全方位洞方位洞察您的订阅结构，优化不必要开支。',
      cat: { ai: 'AI 工具', dev: '开发工具', design: '设计艺术', media: '影音娱乐', cloud: '云服务' },
    },
    download: {
      title: '现在就开始掌控您的订阅。',
      subtitle: '轻量、私密、永久免费。下载 DMG 安装包，数秒内开启您的订阅追踪之旅。',
      cta: '下载 macOS 版',
      dmg: '下载 .dmg 安装镜像',
      requirements: 'macOS 12.0 或更高版本 · 支持 Intel 与 Apple Silicon 芯片',
    },
    footer: {
      rights: '© 2025 BurnRate. 在 GitHub 上开源。',
      github: 'GitHub 仓库',
    },
  },
}
